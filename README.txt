...
a persistence unit "tvanPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/com/vinhhy/tvan/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "tvan/pom.xml":
...
artifacts ("tvan-ejb.jar" and "tvan-web.war") are already built. You can build
